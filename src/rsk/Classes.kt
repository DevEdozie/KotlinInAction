...
//
//
//open class rsk.User(val nickname: String){}
//
//class TwitterUser(nickname: String) : rsk.User(nickname){}
//
...
//        @JvmStatic
//        fun main(args: Array<String>) {
//            val subcribingUser = newSubscribingUser("bob@gmail.com")
//            val facebookUser = newFacebookUser(1)
...
//
//
//    fun Person.nonStaticExtFunc():String{
//        //Extension function
//        return "Non static extension function"
//    }
//
//    //Declare an empty companion object
//    companion object Loader {}
//    // client/server communication module
//    fun Person.Loader.fromJSON(json:String):String{
//        // Static Extension function
//        return "Static extension function"
//    }
//}
//
///*
...
//
//        @JvmField
//        val staticVariable = "Static Variable"
//
//        val nonStaticValue = "Non Static Value"
//
//
//        @JvmStatic
//        fun main(args: Array<String>) {
//            var person1 = fromJSON("{name: 'Dmitry'}")
//            println(person1.name)
//            var person2 = fromJSON("{name: 'Brent'}")
//            println(person2.name)
//        }
//
//        fun notStatic(){
//            println("It's not a static method")
//        }
//
//        @JvmStatic
//        fun isStatic(){
...
//class PrivateUser(override val nickname: String) : rsk.User
//
////overrides the property,  uses a custom getter
//class SubscribingUser(val email: String) : rsk.User {
...
//class FaceBookUser(val accountId: Int) : rsk.User {
...
//}
//
//class rsk.User(val name: String) {
